...
* sistemkoin.conf: contains configuration settings for sistemkoind or sistemkoin-qt
* sistemkoind.pid: stores the process id of sistemkoind while running
...
* debug.log: contains debug information and general logging generated by sistemkoind or sistemkoin-qt
