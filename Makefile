...
pkgdatadir = $(datadir)/sistemkoin
pkgincludedir = $(includedir)/sistemkoin
pkglibdir = $(libdir)/sistemkoin
pkglibexecdir = $(libexecdir)/sistemkoin
...
ACLOCAL = ${SHELL} /tmp/Sistemkoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tmp/Sistemkoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/Sistemkoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/Sistemkoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = sistemkoin-cli
BITCOIN_DAEMON_NAME = sistemkoind
BITCOIN_GUI_NAME = sistemkoin-qt
BITCOIN_TX_NAME = sistemkoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The Sistemkoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Sistemkoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /tmp/Sistemkoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = sistemkoin
PACKAGE_BUGREPORT = https://github.com/sistemkoin-project/sistemkoin/issues
PACKAGE_NAME = Sistemkoin Core
PACKAGE_STRING = Sistemkoin Core 0.16.3
PACKAGE_TARNAME = sistemkoin
PACKAGE_URL = https://sistemkoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /tmp/Sistemkoin
abs_srcdir = /tmp/Sistemkoin
abs_top_builddir = /tmp/Sistemkoin
abs_top_srcdir = /tmp/Sistemkoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/Sistemkoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Sistemkoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Sistemkoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Sistemkoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Sistemkoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
