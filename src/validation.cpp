...
#if defined(NDEBUG)
# error "Sistemkoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Sistemkoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("sistemkoin-scriptch");
