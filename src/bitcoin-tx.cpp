...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sistemkoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sistemkoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sistemkoin transaction") + "\n" +
              "  sistemkoin-tx [options] -create [commands]   " + _("Create hex-encoded sistemkoin transaction") + "\n" +
              "\n";
