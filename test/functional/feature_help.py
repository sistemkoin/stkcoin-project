...
"""Verify that starting sistemkoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sistemkoin with -h for help text")
        ...
        self.log.info("Start sistemkoin with -version for version information")
